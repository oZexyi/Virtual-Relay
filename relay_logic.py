...
LOCATIONS = [
    "Tucker", "Jamestown", "Knoxville", "Oxford", "Goldsboro", "Norfolk", "Lynchburg", "Villa Rica", "Hope Mills",  # Sister Plants
    "Beckley", "Bluefield", "Galax", "Gastonia", "Wilksboro", "Hickory", "Morganton", "Statesville", "Spartanburg",
    "Syvla", "Anderson", "Greenville", "Laurens", "Asheville", "Hendersonville"
]
...
def calculate_stacks_and_trailers(data):
    ...
    for location, counts in data.items():
        ...
        result[location] = {
            ...
            "cake_stack_equiv": counts["cake_pallets"] * 4,
